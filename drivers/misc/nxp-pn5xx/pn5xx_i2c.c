 ...
 */
static int pn54x_get_pdata(struct device *dev, struct pn544_i2c_platform_data *pdata)
{
		...
		const struct i2c_device_id *id)
{
	...
	/* validate the adapter has basic I2C functionality */
 ...
 */
module_i2c_driver(pn54x_driver);
