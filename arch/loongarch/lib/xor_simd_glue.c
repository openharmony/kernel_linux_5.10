...
void xor_##flavor##_2(unsigned long bytes, unsigned long *p1,			\
		      unsigned long *p2)					\
{										\
	kernel_fpu_begin();							\
...
void xor_##flavor##_3(unsigned long bytes, unsigned long *p1,			\
...
void xor_##flavor##_4(unsigned long bytes, unsigned long *p1,			\
		      unsigned long *p2, unsigned long *p3,			\
		      unsigned long *p4)					\
{										\
	kernel_fpu_begin();							\
...
void xor_##flavor##_5(unsigned long bytes, unsigned long *p1,			\
		      unsigned long *p2, unsigned long *p3,			\
