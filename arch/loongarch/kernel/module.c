			...
			s64 *rela_stack, size_t *rela_stack_top, unsigned int type)
{
	...
	offset >>= 2;
	insn->reg0i26_format.simmediate_l = offset & 0xffff;
	insn->reg0i26_format.simmediate_h = (offset >> 16) & 0x3ff;
			...
			s64 *rela_stack, size_t *rela_stack_top, unsigned int type)
{
	...
	case R_LARCH_PCALA_LO12:
		insn->reg2i12_format.simmediate = v & 0xfff;
		break;
	case R_LARCH_PCALA_HI20:
		v = offset_hi20 >> 12;
		insn->reg1i20_format.simmediate = v & 0xfffff;
		break;
