...
unsigned long _kvm_emu_read_csr(struct kvm_vcpu *vcpu, int csrid)
{
	...
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRCTL);
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO1);
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO2);
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRENTRY);
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRERA);
	CASE_READ_SW_GCSR(csr, csrid, KVM_CSR_MERRSAVE);
	...
	unsigned long val)
{
	...
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRCTL, val);
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO1, val);
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO2, val);
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRENTRY, val);
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRERA, val);
	CASE_WRITE_SW_GCSR(csr, csrid, KVM_CSR_MERRSAVE, val);
	...
	unsigned long csr_mask, unsigned long val)
{
	...
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRCTL, csr_mask, val);
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO1, csr_mask, val);
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRINFO2, csr_mask, val);
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRENTRY, csr_mask, val);
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRERA, csr_mask, val);
	CASE_CHANGE_SW_GCSR(csr, csrid, KVM_CSR_MERRSAVE, csr_mask, val);
...
int _kvm_getcsr(struct kvm_vcpu *vcpu, unsigned int id, u64 *v, int force)
{
	...
	GET_SW_GCSR(csr, id, KVM_CSR_MERRCTL, v);
	GET_SW_GCSR(csr, id, KVM_CSR_MERRINFO1, v);
	GET_SW_GCSR(csr, id, KVM_CSR_MERRINFO2, v);
	GET_SW_GCSR(csr, id, KVM_CSR_MERRENTRY, v);
	GET_SW_GCSR(csr, id, KVM_CSR_MERRERA, v);
	GET_SW_GCSR(csr, id, KVM_CSR_MERRSAVE, v);
...
int _kvm_setcsr(struct kvm_vcpu *vcpu, unsigned int id, u64 *v, int force)
{
	...
	SET_SW_GCSR(csr, id, KVM_CSR_MERRCTL, v);
	SET_SW_GCSR(csr, id, KVM_CSR_MERRINFO1, v);
	SET_SW_GCSR(csr, id, KVM_CSR_MERRINFO2, v);
	SET_SW_GCSR(csr, id, KVM_CSR_MERRENTRY, v);
	SET_SW_GCSR(csr, id, KVM_CSR_MERRERA, v);
	SET_SW_GCSR(csr, id, KVM_CSR_MERRSAVE, v);
