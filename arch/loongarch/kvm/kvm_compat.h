...
#define KVM_CSR_MERRCTL		0x90	/* ERRCTL */
#define KVM_CSR_MERRINFO1	0x91	/* Error info1 */
#define KVM_CSR_MERRINFO2	0x92	/* Error info2 */
#define KVM_CSR_MERRENTRY	0x93	/* Error exception base address */
#define KVM_CSR_MERRERA		0x94	/* Error exception PC */
#define KVM_CSR_MERRSAVE		0x95	/* KScratch for machine error exception */
