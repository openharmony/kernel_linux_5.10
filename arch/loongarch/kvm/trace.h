...
#define KVM_TRACE_EXIT_HC	(EXCCODE_HVC)
...
#define kvm_trace_symbol_exit_types					\
	...
	{ KVM_TRACE_EXIT_TLBNR,		"TLB RI" },		\
	{ KVM_TRACE_EXIT_TLBNX,		"TLB XI" },		\
